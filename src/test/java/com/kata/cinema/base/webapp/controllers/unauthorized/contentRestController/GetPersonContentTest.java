...
public class GetPersonContentTest {
    ...
    @Test
    @Sql(scripts = "/data/sql/controllers/contentRestController/getPersonContent/init.sql",
         executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
    @Sql(scripts = "/data/sql/controllers/contentRestController/getPersonContent/delete.sql",
         executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
    public void getPersonContentTest() throws Exception {
        ...
        mockMvc.perform(get("/api/person/100/content"))
    ...
    @Sql(scripts = "/data/sql/controllers/contentRestController/getPersonContent/delete.sql",
         executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
    public void negativeGetPersonContentTest() throws Exception {

        mockMvc.perform(get("/api/person/2/content"))
